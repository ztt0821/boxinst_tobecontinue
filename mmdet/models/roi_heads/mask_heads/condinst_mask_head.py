...
class CondinstmaskHead(BaseModule):
    def __init__(self,
        ...
        self.in_features = input_feature
        ...
        if self.sem_loss:
            ...
            self.seg_head = nn.Sequential(
                ConvModule(in_channels, channels, kernel_size=3, stride=1),
                ConvModule(channels, channels, kernel_size=3, stride=1)
            )
    ...
    def forward(self, features, gt_instances=None):
        ...
        if self.training and self.sem_loss:
