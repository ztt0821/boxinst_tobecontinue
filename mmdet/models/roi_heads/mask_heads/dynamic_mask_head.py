...
class dynamicmask_head(BaseModule):
    def __init__(self,
                 num_layers,
                 channels,
                 in_channels,
                 ...
                 size_of_fcos,
                 boxinst=None,
                 bottom_pixels_remove=None,
                 pairwise_size=None,
                 pairwise_dilation=None,
        ...
        self.disable_rel_coords = disbale_rel_coords

        soi = size_of_fcos
        self.register_buffer("sizes_of_interest", torch.tensor(soi + [soi[-1] * 2]))

        self.boxinst_enabled = boxinst
        self.bottom_pixels_removed = bottom_pixels_remove
        self.pairwise_size = pairwise_size
        self.pairwise_dilation = pairwise_dilation
        self.pairwise_color_thresh = color_threshold
